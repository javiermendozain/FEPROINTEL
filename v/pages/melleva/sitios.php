 ...
 */
    ...
    class public_sitios_public_plan_viajePage extends DetailPage
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->setDecimalSeparator('');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText('Cupos apartar ó cupos disponibles'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_list', $column);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje_id_cliente_nombre_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    class public_sitios_public_plan_viaje01Page extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridpublic.sitios.public.plan_viaje01_id_cliente_nombre_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    class public_sitiosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserGrantForDataSource('public.sitios.public.plan_viaje')->HasViewGrant() && $withDetails)
            {
            //
            // View column for public_sitios_public_plan_viaje detail
            //
            $column = new DetailColumn(array('id_sitio'), 'public.sitios.public.plan_viaje', 'public_sitios_public_plan_viaje_handler', $this->dataset, 'Plan Viaje');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserGrantForDataSource('public.sitios.public.plan_viaje01')->HasViewGrant() && $withDetails)
            {
            //
            // View column for public_sitios_public_plan_viaje01 detail
            //
            $column = new DetailColumn(array('id_sitio'), 'public.sitios.public.plan_viaje01', 'public_sitios_public_plan_viaje01_handler', $this->dataset, 'Plan Viaje');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_sitiosGrid_id_grupo_nombre_grupo_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_sitiosGrid_id_grupo_nombre_grupo_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_sitiosGrid_id_grupo_nombre_grupo_handler_print');
            $grid->AddPrintColumn($column);
        }
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_sitiosGrid_id_grupo_nombre_grupo_handler_export');
            $grid->AddExportColumn($column);
        }
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_sitiosGrid_id_grupo_nombre_grupo_handler_compare');
            $grid->AddCompareColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new public_sitios_public_plan_viajePage('public_sitios_public_plan_viaje', $this, array('id_sitio_destino'), array('id_sitio'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserGrantForDataSource('public.sitios.public.plan_viaje'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('public.sitios.public.plan_viaje'));
            $detailPage->SetTitle('Plan Viaje');
            $detailPage->SetMenuLabel('Plan Viaje');
            $detailPage->SetHeader(GetPagesHeader());
            $detailPage->SetFooter(GetPagesFooter());
            $detailPage->SetHttpHandlerName('public_sitios_public_plan_viaje_handler');
            $handler = new PageHTTPHandler('public_sitios_public_plan_viaje_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $detailPage = new public_sitios_public_plan_viaje01Page('public_sitios_public_plan_viaje01', $this, array('id_sitio'), array('id_sitio'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserGrantForDataSource('public.sitios.public.plan_viaje01'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('public.sitios.public.plan_viaje01'));
            $detailPage->SetTitle('Plan Viaje');
            $detailPage->SetMenuLabel('Plan Viaje');
            $detailPage->SetHeader(GetPagesHeader());
            $detailPage->SetFooter(GetPagesFooter());
            $detailPage->SetHttpHandlerName('public_sitios_public_plan_viaje01_handler');
            $handler = new PageHTTPHandler('public_sitios_public_plan_viaje01_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_grupo', 'id_grupo_nombre_grupo', 'Id Grupo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_sitiosGrid_id_grupo_nombre_grupo_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_grupo', 'id_grupo_nombre_grupo', 'Id Grupo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_sitiosGrid_id_grupo_nombre_grupo_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_grupo', 'id_grupo_nombre_grupo', 'Id Grupo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_sitiosGrid_id_grupo_nombre_grupo_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_grupo', 'id_grupo_nombre_grupo', 'Id Grupo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_sitiosGrid_id_grupo_nombre_grupo_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new public_sitiosPage("public_sitios", "sitios.php", GetCurrentUserGrantForDataSource("public.sitios"), 'UTF-8');
        $Page->SetTitle('Sitios');
        $Page->SetMenuLabel('Sitios');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.sitios"));

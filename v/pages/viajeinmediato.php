                            ...
                            <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                          <!-- Contenido-->
                                                <form role="form"   method="post" action="inmediato.php" >

                                                    <div class="form-group">
                                                        <label> <i class="fa fa-clock-o"> </i> Hora salida</label>
                                                        <input type="time" class="form-control" name="hora" placeholder="Hora de salida">
                                                   ...
                                                   <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        <label>Modalidad de Viaje: <br></label>
                                                            ...
                                                            <label class="radio-inline" >
                                                                <input type="radio" name="modo" id="optionsRadios1" value="0"    onclick="mostrar()" > <i class="fa fa-automobile "></i> Conductor
                                                            </label>
                                                           <label class="radio-inline">
                                                                <input type="radio" name="modo" id="optionsRadios2" value="1"  onclick="ocultar()"  checked> <i class="fa fa-child   "></i>  Pasajero
                                                            </label>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="idcli" value="<?php echo $nombre_user ?>">
                                                    </div>
